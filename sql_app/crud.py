...
# Cria tipos e adiciona eles na tabela de eventos
...
# Cria locais e adiciona eles na tabela de eventos
...
def update_tipo(tipo_id: int, tipo: dict):
    ...
    for key, value in tipo.items():
        ...
        if key == "evento_id" and value != None:
            tipo_db[tipo_id]["evento_id"] = value
        else:
            if value != None:
...
def update_local(local_id: int, local: dict):
    ...
    for key, value in local.items():
        print(key, value)
        if key == "evento_id" and value != None:
            local_db[local_id]["evento_id"] = value
