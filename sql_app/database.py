...
default_engine = create_engine("mysql+pymysql://root:SelberCodes2024!@localhost")
...
engine = create_engine(f"mysql+pymysql://root:SelberCodes2024!@localhost/{database_name}")
